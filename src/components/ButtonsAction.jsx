    ...
    <>
      ...
      <div className="mt-1.5 flex gap-1">
        <Button
          variant="outline"
          title="Thích"
          className="h-9 cursor-pointer rounded-full border-0 px-3 font-normal shadow-none hover:bg-[rgba(245,245,245,1)]"
        >
          <span>
            <svg
              role="img"
              viewBox="0 0 18 18"
              className="size-1 h-4.75 w-4.75"
            >
              <path
          ...
          {!!likeNumber && <span>{likeNumber}</span>}
        </Button>
        ...
        >
          <span>
            <svg role="img" viewBox="0 0 18 18" className="size-1 h-4.5 w-4.5">
              <path
                className="fill-transparent stroke-black"
        ...
        >
          ...
          {!!rePostNumber && <span>{rePostNumber}</span>}
        </Button>
        ...
        >
          ...
          {!!shareNumber && <span>{shareNumber}</span>}
        </Button>
      </div>
    </>
  );
